...
mod_day1 <- generate_STb_model(data_list_day1)
mod_day1_comp <- generate_STb_model(data_list_day1, transmission_func="freqdep_f")
...
get_ilv_results(summ, "Distsq")
get_ilv_results(summ, "Day1")
get_ilv_results(summ, "Day1_comp")
