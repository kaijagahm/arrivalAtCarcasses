...
model_3_weibull <- generate_STb_model(data_list, gq = T, est_acqTime = T, intrinsic_rate = "weibull")
write(model_3_weibull, file="data/stan_models/model_3_weibull.stan")
...
fit_weibull <- fit_STb(data_list,
                       ...
                       iter = 500,
                       refresh=50)
STb_save(fit_weibull, output_dir = "data/cmdstan_saves", name="dynamic_daylight_ilvs3_weibull")
fit_weibull <- readRDS('data/cmdstan_saves/dynamic_daylight_ilvs3_weibull.rds') 
# 
