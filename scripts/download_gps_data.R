...
write_rds(od22, file = here("data/ornitela_data_2022_version2025-09-21.RDS"))
write_rds(od23, file = here("data/ornitela_data_2023_version2025-09-21.RDS"))
write_rds(od24, file = here("data/ornitela_data_2024_version2025-09-21.RDS"))
write_rds(id22, file = here("data/inpa_data_2022_version2025-09-21.RDS"))
write_rds(id23, file = here("data/inpa_data_2023_version2025-09-21.RDS"))
write_rds(id24, file = here("data/inpa_data_2024_version2025-09-21.RDS"))
