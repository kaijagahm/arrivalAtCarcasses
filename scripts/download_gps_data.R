...
od22 <- od22 %>% select(-any_of(toremove))
od23 <- od23 %>% select(-any_of(toremove))
od24 <- od24 %>% select(-any_of(toremove))
id22 <- id22 %>% select(-any_of(toremove))
id23 <- id23 %>% select(-any_of(toremove))
id24 <- id24 %>% select(-any_of(toremove))
