...
#write_rds(networks_long_dynamic, file = "data/created/networks_long_dynamic3.RDS")
networks_long_dynamic <- readRDS("data/created/networks_long_dynamic3.RDS")
