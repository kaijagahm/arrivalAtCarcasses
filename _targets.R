...
list(
  ...
  tar_target(fl_allday_wt_see, get_fl_wt_list(gps_flight_allday_see, detection_distance)),
  ...
  tar_target(fl_cumulative_wt_see, get_fl_wt_list(gps_flight_cumulative_see, detection_distance)),
  ...
  tar_target(fl_3hr_wt_see, get_fl_wt_list(gps_flight_3hr_see, detection_distance)),
