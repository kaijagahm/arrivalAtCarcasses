...
for(i in 1:length(datasets)){
 datasets[[i]] <- make_nbda_data(idx = 29, lbl = lbl, network = datasets_to_make$network[i], ilvs = datasets_to_make$ilvs[i])
}
map(datasets, str)
...
# XXX not clear how to move forward here with the model averaging
