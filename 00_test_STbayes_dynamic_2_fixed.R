...
write_rds(data_list, file="data/data_lists/dynamic_daylight_ilvs2_fixed.RDS")
...
write(model_full_dynamic, file="data/stan_models/dynamic_daylight_ilvs2_fixed.stan")
